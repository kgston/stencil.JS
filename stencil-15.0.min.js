...
c||stencil.opts.defaultOutputElement,"after"));f.destination=d;return f}f=b||$("#"+stencil.util.escapeCSS(a));if(f.length)null==d&&(d=stencil.util.createWrapper(f,c||stencil.opts.defaultOutputElement,"after")),b=f.detach();else return stencil.util.log("Stencil: Tag ID '"+a+"' provided is not found!"),null;null!=b.attr("data-childStencil")&&""!=b.attr("data-childStencil")&&(null==g&&(g=[]),b.attr("data-childStencil").split(" ").forEach(function(b){""!=b&&g.push(b)}));var m={};stencil.util.log("Stencil: Searching for child stencils in "+
...
(function(){var a=stencil.util.isIE();0!=a&&10>a&&(document.createElement("stencil"),document.createElement("stencil-replicator"),document.createElement("stencil-output"),stencil.opts.ieNs="STENCIL:")})(); //# sourceMappingURL=stencil-15.0.min.map
