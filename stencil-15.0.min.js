...
stencil=$.extend(stencil||{},function(){return{stencilHolder:{},fetch:function(a){if(null==a)stencil.util.log("Stencil: No valid URL was passed in");else{var d=$.Deferred();$.ajax({url:a,method:"GET",dataType:"html",timeout:stencil.opts.fetchTimeout}).done(function(c){c=c.replace(/\x3c!--((.|\n)*?)--\x3e/gm,"");var b=$(c);0===b.length&&stencil.util.log("Stencil: Unable to parse fetched template at <"+a+">");var e=[];b.each(function(c){"STENCIL"!==this.nodeName&&stencil.util.log("Stencil: Fetched template("+
(c+1)+"/"+b.length+") at <"+a+"> is not a stencil template");c=$(this);c=stencil.define(c[0].id,"none",null,c);e.push(c);d.notify(c)});d.done(e)}).fail(function(c){stencil.util.log("Stencil: Failed to fetched template at <"+a+"> due to "+c.status+":"+c.statusText)});return d.promise()}},define:function(a,d,c,b){var e=function(a,b,c){return{guid:stencil.util.guid(),tagID:a,template:c,childStencils:{},isStandard:!0,destination:b,existingContent:"",clear:function(){$(this.destination).empty().append(this.existingContent)},
