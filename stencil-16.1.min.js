...
this.tagID+": was not passed in data"),!1;var d=this.destination,e=!1,g;if(null==c){c=$(d);if("none"===d||"none"===a||"string"===a||"fragment"===a)if("none"===a||"string"===a||"fragment"===a)g=$(document.createElement("div"));else return stencil.util.log('Stencil: Only render output type "none", "fragment" or "string" is supported for stencils with no destination'),!1;else g=c.filter(":first").clone();e=!0}else g=c.find(d.replace(/\\(?=\{|\})/g,"\\\\\\"));var k=this.template,h=this.childStencils,
f=this.isStandard;if(g.length)"append"===a||"prepend"===a?(this.existingContent=g.html(),g.empty()):"none"===a?(c.empty(),g.empty()):"string"!==a&&"fragment"!==a&&g.empty();else return stencil.util.log("Stencil: Destination ID - "+d+" not found!"),!1;b.forEach(function(b,a){b.lpIdx=a;b.ctIdx=a+1;for(var c=k;0<=c.search(/\{\{[\w.]*\}\}/);)var e=c.match(/\{\{[\w.]*\}\}/)[0],e=e.substring(2,e.length-2),m=stencil.util.getKeyValue(b,e),m=null==m?"":m,c=c.replace("{{"+e+"}}",m);var l=g;f&&(e=stencil.util.createWrapper(g,
"stencil-replicator","append"),l=g.find(e));l.append(c);f||l.removeClass(d.replace(".",""));Object.keys(h).forEach(function(a){var c=b[a];null!=b.global&&(Array.isArray(c)?c.forEach(function(a){a.global=b.global}):stencil.util.isObject(c)&&(c.global=b.global));h[a].render(c,null,l)});l.find("select[data-stencilselector]").each(function(){var a=this.getAttribute("data-stencilselector");stencil.util.selectOption($(this),stencil.util.getKeyValue(b,a))})});"prepend"===a&&g.append(this.existingContent);
if(e){stencil.util.cleanUpStencils(g);if("none"===a||"fragment"===a)return g.children();if("string"===a)return g.html();"append"!==a&&c.empty();c.append(g.children());return!0}}}},h=function(b){var a=e(b.tagID,b.destination,b.template);Object.keys(b.childStencils).forEach(function(c){a.childStencils[c]=h(b.childStencils[c])});return a},f;if(null!=stencil.stencilHolder[a]&&null==b)return a=stencil.stencilHolder[a],b=h(a),null==d&&(d=stencil.util.createWrapper($(a.destination),c||stencil.opts.defaultOutputElement,
"after")),b.destination=d,b;b=b||$("#"+stencil.util.escapeCSS(a));if(b.length)null==d&&(d=b.attr("data-stencilDestination")),null==d&&(d=stencil.util.createWrapper(b,c||stencil.opts.defaultOutputElement,"after")),b=b.detach();else return stencil.util.log("Stencil: Tag ID '"+a+"' provided is not found!"),null;null!=b.attr("data-childStencil")&&""!=b.attr("data-childStencil")&&(null==f&&(f=[]),b.attr("data-childStencil").split(" ").forEach(function(b){""!=b&&f.push(b)}));c={};stencil.util.log("Stencil: Searching for child stencils in "+
...
d);e.className=""===e.className?b:e.className+" "+b;a[c](e);return stencil.util.escapeCSS(stencil.opts.ieNs)+d+"."+b},findStencils:function(a){function d(b,a){for(var c=b.childNodes,f=0;f<c.length;f++){var k;k=c[f];k="STENCIL"===k.nodeName||"stencil"===k.nodeName?!0:!1;k?a[c[f].id]=stencil.define(c[f].id,null,"stencil-output",$(c[f])):d(c[f],a)}}var c={};d(a.get(0),c);return c},cleanUpStencils:function(a){function d(a){if(function(a){return 0<=a.nodeName.indexOf("STENCIL")||0<=a.nodeName.indexOf("stencil")?
...
Object(a)},log:function(a){stencil.opts.debug&&console.log(a)}}}}());(function(){var a=stencil.util.isIE();0!=a&&10>a&&(document.createElement("stencil"),document.createElement("stencil-replicator"),document.createElement("stencil-output"),stencil.opts.ieNs="STENCIL:")})(); //# sourceMappingURL=stencil-16.1.min.map
